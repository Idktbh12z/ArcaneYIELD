...
Title.TextSize = 18
Title.Text = "Arcane Yield v" .. currentVersion
	...
	local function FLY()
		...
		task.spawn(function()
			repeat task.wait()
				...
				if getRoot(Players.LocalPlayer.Character):FindFirstChild("SwimVelocity") then getRoot(Players.LocalPlayer.Character):FindFirstChild("SwimVelocity"):Destroy() end
